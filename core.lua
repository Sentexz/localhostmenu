--[[
    SENTEX CORE v3.7
    Núcleo del menú: sistema de dibujo, navegación, gestión de entrada y temas.
    Expone funciones para que los módulos agreguen contenido dinámicamente.
]]
...
function Menu.ApplyTheme(themeName)
    ...
    if themeLower == "red" then
        ...
        Menu.Banner.imageUrl = "https://i.imgur.com/jnKfAh1.png"
...
-- Exponer el menú globalmente para que modules.lua pueda agregar categorías
_G.Menu = Menu
Notify("~b~[SENTEX] Core cargado")
